...
public class ShopOrder extends PersistableOrder implements Serializable {
	...
	private List<ShoppingCartItem> shoppingCartItems;// overrides parent API
														// list of
														// shoppingcartitem

	private OrderTotalSummary orderTotalSummary;// The order total displayed to
												// the end user. That object
												// will be used when committing
												// the order

	private ShippingSummary shippingSummary;
	private ShippingOption selectedShippingOption = null;// Default selected
															// option
